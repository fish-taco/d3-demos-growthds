...
// load the data
d3.json("12months_departures_joiners.json", function(error, graph) {
d3.csv("clusters.csv",function(error,clust){
...
function nodemouseover(d){
  ...
  d3.selectAll(".link")
      ...
      $("#clusdesc").html(desc);
      $("#depart").html(d.departing+" of these users left the platform in the following period.");
      $("#joined").html(d.joining+" new users joined the game into this cluster.");
      $("#instructions").html("Click on a node to explore the entire history of this user group.");
    }
...
d3.csv("clustclicked.csv", function(clustclick) {
