        ...
        3: [function(require, module, exports) {
            ...
            function() {
                function FunnelGraph(options) {
                    ...
                    this.colors = options.data.colors || (0,
                    _graph.getDefaultColors)(this.is2d() ? this.getSubDataSize() : 2);
   ...
   */
                ...
                _createClass(FunnelGraph, [{
                    ...
                    value: function getMainAxisPoints() {
                        ...
                        for (var i = 0; i <= size; i++) {
                            points.push((0,
                            _number.roundPoint)(fullDimension * i / size));
                        }
                    ...
                    value: function getCrossAxisPoints() {
                        ...
                        if (this.is2d()) {
                            ...
                            points.push(totalValues.map(function(value) {
                                return (0,
                                _number.roundPoint)((max - value) / max * dimension);
                            }));
                            ...
                            for (var i = 1; i < this.getSubDataSize(); i++) {
                                ...
                                for (var j = 0; j < this.getDataSize(); j++) {
                                    newPoints.push((0,
                                    _number.roundPoint)(// eslint-disable-next-line comma-dangle
                            ...
                            points.push(values.map(function(value) {
                                return (0,
                                _number.roundPoint)((_max - value) / _max * dimension);
                            }));
                    ...
                    value: function addLabels() {
                        ...
                        this.percentages.forEach(function(percentage, index) {
                            ...
                            value.textContent = (0,
                            _number.formatNumber)(valueNumber);
                    ...
                    value: function addSubLabels() {
                        ...
                        if (this.subLabels) {
                            ...
                            this.subLabels.forEach(function(subLabel, index) {
                                ...
                                _graph.generateLegendBackground)(_this2.colors[index], _this2.gradientDirection), "\"></div>\n    <div class=\"svg-funnel-js__subLabel--title\">").concat(subLabel, "</div>\n</div>");
                            });
                    ...
                    value: function getPercentages2d() {
                        ...
                        this.values.forEach(function(valueSet) {
                            ...
                            percentages.push(valueSet.map(function(value) {
                                return (0,
                                _number.roundPoint)(value * 100 / total);
                            }));
                        });
                        return percentages;
                    }
                    ...
                    value: function createPercentages() {
                        ...
                        return values.map(function(value) {
                            return (0,
                            _number.roundPoint)(value * 100 / max);
                        });
                    }
                }, {
                    key: "applyGradient",
                    value: function applyGradient(svg, path, colors, index) {
                        var defs = svg.querySelector('defs') === null ? (0,
                        _graph.createSVGElement)('defs', svg) : svg.querySelector('defs');
                        var gradientName = "funnelGradient-".concat(index);
                        var gradient = (0,
                        _graph.createSVGElement)('linearGradient', defs, {
                            id: gradientName
                        });

                        if (this.gradientDirection === 'vertical') {
                            (0,
                            _graph.setAttrs)(gradient, {
                                x1: '0',
                                x2: '0',
                                y1: '0',
                                y2: '1'
                        ...
                        for (var i = 0; i < numberOfColors; i++) {
                            (0,
                            _graph.createSVGElement)('stop', gradient, {
                                'stop-color': colors[i],
                    ...
                    value: function makeSVG() {
                        var svg = (0,
                        _graph.createSVGElement)('svg', this.graphContainer, {
                            width: this.getWidth(),
                        ...
                        for (var i = 0; i < valuesNum; i++) {
                            var path = (0,
                            _graph.createSVGElement)('path', svg);
     ...
     */
                    ...
                    value: function createPath(index) {
                        ...
                        for (var i = 0; i < X.length - 1; i++) {
                            str += (0,
                            _path.createCurves)(X[i], Y[i], X[i + 1], Y[i + 1]);
                        }
                        ...
                        for (var _i = X.length - 1; _i > 0; _i--) {
                            str += (0,
                            _path.createCurves)(X[_i], YNext[_i], X[_i - 1], YNext[_i - 1]);
                        }
     ...
     */
                    ...
                    value: function createVerticalPath(index) {
                        ...
                        for (var i = 0; i < X.length - 1; i++) {
                            str += (0,
                            _path.createVerticalCurves)(X[i], Y[i], X[i + 1], Y[i + 1]);
                        }
                        ...
                        for (var _i2 = X.length - 1; _i2 > 0; _i2--) {
                            str += (0,
                            _path.createVerticalCurves)(XNext[_i2], Y[_i2], XNext[_i2 - 1], Y[_i2 - 1]);
                        }
     ...
     */
                    ...
                    value: function gradientMakeHorizontal() {
                        ...
                        gradients.forEach(function(gradient) {
                            (0,
                            _graph.removeAttrs)(gradient, 'x1', 'x2', 'y1', 'y2');
                        });
                        return true;
                    }
                }, {
        ...
        5: [function(require, module, exports) {
            ...
            var createCurves = function createCurves(x1, y1, x2, y2) {
                return " C".concat((0,
                _number.roundPoint)((x2 + x1) / 2), ",").concat(y1, " ") + "".concat((0,
                _number.roundPoint)((x2 + x1) / 2), ",").concat(y2, " ").concat(x2, ",").concat(y2);
            };

            exports.createCurves = createCurves;

            var createVerticalCurves = function createVerticalCurves(x1, y1, x2, y2) {
                return " C".concat(x1, ",").concat((0,
                _number.roundPoint)((y2 + y1) / 2), " ") + "".concat(x2, ",").concat((0,
                _number.roundPoint)((y2 + y1) / 2), " ").concat(x2, ",").concat(y2);
            };
